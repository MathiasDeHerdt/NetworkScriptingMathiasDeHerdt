...
printf 'zone "nmctinternal.be" {' >>${NAMED_CONF_LOCAL}
printf "      type master;" >>${NAMED_CONF_LOCAL}
printf '      file "/etc/bind/zones/nmctinternal.be";' >>${NAMED_CONF_LOCAL}
printf "};" >>${NAMED_CONF_LOCAL}

printf "" >>${NAMED_CONF_LOCAL}

printf 'zone "X.168.192.in-addr.arpa" {' >>${NAMED_CONF_LOCAL}
printf "      type master;" >>${NAMED_CONF_LOCAL}
printf '     file "/etc/bind/zones/reverse/rev.X.168.192";' >>${NAMED_CONF_LOCAL}
printf "};" >>${NAMED_CONF_LOCAL}
